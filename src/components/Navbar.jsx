...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-16 md:h-20 flex items-center justify-between bg-white shadow-md z-50 px-4 md:px-8">
      {/* LOGO */}
      <Link to="/" className="flex items-center gap-4 text-2xl font-bold">
        <Image src="logo.webp" alt="Hailey Logo" w={32} h={32} />
        <span>Art Blog</span>
      </Link>
